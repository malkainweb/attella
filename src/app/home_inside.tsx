  ...
  return (
    <>
      ...
      <div className="w-full h-[100vh] flex justify-center items-center bg-red-600 text-white text-[5vw] font-bold uppercase">
        this is the second homepage
      </div>{" "}
      <div className="w-full h-[100vh] flex justify-center items-center bg-gray-400 text-blue-600 text-[5vw] font-bold uppercase">
        this is the third homepage
      </div>{" "}
    </>
  );
};
